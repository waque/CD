...
base_clfs = [BernoulliNB(), DecisionTreeClassifier(), KNeighborsClassifier(), RandomForestClassifier(n_estimators=100), VotingClassifier(estimators=[('nb', BernoulliNB()), ('dt', DecisionTreeClassifier()), ('knn', KNeighborsClassifier)], voting='hard')]
